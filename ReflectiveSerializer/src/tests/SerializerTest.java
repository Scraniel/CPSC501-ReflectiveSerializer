...
public class SerializerTest {
	...
	public void testSimpleObject() 
	{
		...
		Document output = serializer.serialize(first);
		String result = outputter.outputString(output);
	...
	public void testObjectWithReferences()
	{
		...
		Document output = serializer.serialize(instance);
		String result = outputter.outputString(output);
		...
		output = serializer.serialize(one);
		result = outputter.outputString(output);
	...
	public void testObjectWithPrimitiveArray()
	{
		...
		Document output = serializer.serialize(pArray);
		String result = outputter.outputString(output);
	...
	public void testObjectWithObjectArray()
	{
		...
		Document output = serializer.serialize(oArray);
		String result = outputter.outputString(output);
	...
	public void testObjectWithCollection()
	{
		...
		Document output = serializer.serialize(col);
		String result = outputter.outputString(output);
